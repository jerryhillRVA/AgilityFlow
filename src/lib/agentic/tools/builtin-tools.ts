  ...
  agentic_fs_write: {
    ...
    input_schema: {
      ...
      properties: {
        ...
        category: { type: 'string', enum: ['requirements', 'design', 'implementation', 'verification', 'other'], description: 'Artifact category — REQUIRED. Use requirements for specs/criteria, design for architecture/contracts/specs, implementation for code, verification for tests/reviews.' },
      },
  ...
  create_subtask: {
    ...
    input_schema: {
      ...
      properties: {
        ...
        assigned_agent: { type: 'string', description: 'Agent ID to assign (e.g. backend-designer, frontend-designer, design-reviewer, technical-writer, qa-analyst)' },
